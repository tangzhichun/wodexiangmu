...
var roleSetting = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        changeList(item, index) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/privilege/role/${item.id}`).then(response => {
                var result = response;
                if (result.success) {
        ...
        submitForm(formName) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post(url, roleSetting.newRole).then(response => {
                if (response.success) {
        ...
        editForm(formName) {
            ...
            var url = '/api/privilege/role';
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(url, roleSetting.newRole).then(response => {
                if (response.success) {
        ...
        delRole(item) {
            ...
            this.$msgbox({
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(url).then(response => {
                    if (response.success) {
                        roleSetting.$message({
                            type: 'success',
                            message: '删除成功!'
    ...
    created() {
        ...
        __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(url).then(response => {
            ...
            if (result.success) {
                ...
                // 获取第一个的权限
                if (!obj || !obj.item) {
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/privilege/role/${roleSetting.roleList[0].id}`).then(response => {
                        var result = response;
                        if (result.success) {
                            roleSetting.newRole = JSON.parse(JSON.stringify(result.data));
