...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ui_dsp_img_vue__ = __webpack_require__(67);
...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        openAudit(el) {
            ...
            self.views.loading = true;
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/mpuser/service/promotion/selectRemark?id=${el.id}`).then(res => {
                self.views.loading = false;
                if (res.code === '000') {
        ...
        save(type) {
            ...
            function f(obj) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/mpuser/service/promotion/updateStatus', obj).then(res => {
    ...
    created() {
        let self = this;
        let arr = JSON.parse(JSON.stringify(__WEBPACK_IMPORTED_MODULE_3__scripts_module_enums__["default"].dict('PARTNERSHIP')));
        arr.map(el => {
