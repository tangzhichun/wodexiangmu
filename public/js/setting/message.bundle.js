...
var message = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        getUrl() {
            ...
            let url = this.urlCord("/api/message/list/" + this.pagination.currentPage + "/" + this.pagination.pageSize, obj);
        ...
        doQuery() {
            let self = this;
            this.loading = true;
            let flag = this.validate.mobile(this.query.receiver);
            if (flag) return;
