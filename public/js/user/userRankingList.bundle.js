...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    delimiters: ['{[', ']}'],
    data: {
        lists: [{ label: '曝光次数排行榜', value: 'cishu', inner: '按访客的访问次数合计值排序' }, { label: '曝光人数排行榜', value: 'renshu', inner: '按访客总数排序，一个访客多次访问只统计一次' }, { label: '获客排行榜', value: 'huoke', inner: '按报名总数排序，一个客户多次报名只统计一次' }],
        // 界面输入的查询条件
        query: {
            cishu: {
                queryTime: 'THIS_WEEK',
