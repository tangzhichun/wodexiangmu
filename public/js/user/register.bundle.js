...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    data: {
        ...
        meta: {
            ...
            ineffectiveReasons: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].INEFFECTIVE_REASONS,
            registerUserStage: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].registerUserStage
        },
        // 界面输入的查询条件
        templateQuery: {
    ...
    methods: {
        ...
        doQuery: function doQuery() {
            var self = this;
            //点击查询按钮，重置为第一页
            var tab = self.query[self.query.category].currentPage;
            self.fetchData();
        },

        //  序号
        indexMethod: function indexMethod(index) {
            var tab = this.query[this.query.category];
            var i = tab.pageSize * (tab.currentPage - 1) + 1;
            return i + index;
        },
        ...
        fetchData: function fetchData() {
            ...
            var trueQuery = self.query[self.query.category];
            var url = '/api/wechat/admin/userMp/register/info?page=' + trueQuery.currentPage + '&size=' + trueQuery.pageSize;
            var params = {
        ...
        //判断是否可以导出Excel(待回访订单)
        handleOrderSubmitDateRangeSet: function handleOrderSubmitDateRangeSet() {
            var self = this;
            var submitDateRangeCount = 0;
        ...
        urlSearch: function urlSearch(query) {
        ...
        //点击反馈
        clickTickling: function clickTickling(e) {
        ...
        saveChange: function saveChange() {
            ...
            if (!this.views.saveChange) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"])({
                    ...
                    _this.views.saveChange = false;
                    if (res.code === '000') {
                        _this.doQuery();
                        _this.$message.success('回馈成功');
                        _this.views.dialogVisible = false;
                    }
                }).catch(function (err) {
                    _this.views.saveChange = false;
                });
    ...
    created: function created() {
        ...
        self.fetchData();
        var date = new Date(DSP.serverTime);
        this.dat = {
            y: date.getFullYear(),
