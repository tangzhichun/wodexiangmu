...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    data: {
        ...
        exportQuery: {},
        meta: {
            levels: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].levels,
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            ...
            var url = '/api/wechat-admin-service/wechat/admin/userMp/findUserMps?page=' + self.query.currentPage + '&size=' + self.query.pageSize;
            var params = {
    ...
    computed: {
        exportLinkStr: function exportLinkStr() {
            var self = this;
            var exportLinkStr = '?submitStartDate=' + self.orderExportObj.submitDateArr[0] + '&submitEndDate=' + self.orderExportObj.submitDateArr[1];
