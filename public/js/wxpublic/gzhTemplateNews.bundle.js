...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        indexMethod: function indexMethod(index) {
            ...
            var i = this.query[tab].size * (this.query[tab].page - 1) + 1;
            return i + index;
        },

        // ajax
        fetchData: function fetchData(f) {
            var self = this;
            var tab = this.query.currentTab;
            ...
            var url = '/api/wechat-service/wechat/queryTemplateMessageLogPage';
            var params = self.query[tab];
            if (f == 1) {
                params.page = 1;
            }
            var qu = {
