...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ui_dsp_empty_vue__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ui_dsp_cropper_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_phone_vue__ = __webpack_require__(82);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    delimiters: ['{[', ']}'],
    components: {
        'empty': __WEBPACK_IMPORTED_MODULE_3__components_ui_dsp_empty_vue__["a" /* default */],
        'dsp-cropper': __WEBPACK_IMPORTED_MODULE_4__components_ui_dsp_cropper_vue__["a" /* default */],
        'dsp-phone': __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_phone_vue__["a" /* default */]
    },
    data: {
        // 基础图片地址
    ...
    methods: {
        //  切换tab
        changeCategories: function changeCategories(item) {
        ...
        //获取标签组
        getTagGroup: function getTagGroup() {
            var _this = this;

            this.buildHash();
            this.loadingS.leftBox = false;
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/sign/type/index').then(function (res) {
                _this.loadingS.leftBox = true;
                _this.requestTagGroup = JSON.parse(JSON.stringify(res.data)) || [];
                _this.requestTagGroup.map(function (el) {
        ...
        //新增  标签 || 标签组
        addTagGroup: function addTagGroup(type) {
            if (type === 'tagList') {
                this.addTagObj();
            }
            this[type].edit = null;
        ...
        //取消新增标签组   清空新增标签组数据
        cancelSaveTagGroup: function cancelSaveTagGroup(type) {
            this[type].status = 0;
        ...
        //保存标签组  新增
        saveTagGroup: function saveTagGroup() {
            var _this2 = this;

            var obj = this.tagGroup.add;
            //判断图片是否为空
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"])({
                ...
                _this2.loadingS.saveTagGroup = true;
                if (res.success) {
                    _this2.cancelSaveTagGroup('tagGroup');
                    _this2.getTagGroup();
                }
            }).catch(function (err) {
                _this2.loadingS.saveTagGroup = true;
        ...
        //保存标签组  修改
        saveEditTagGroup: function saveEditTagGroup() {
            var _this3 = this;

            var obj = this.tagGroup.edit;
            //判断图片是否为空
            if (!obj.stCoverUrlobj || obj.stCoverUrlobj && !obj.stCoverUrlobj.imageUrl) {
                this.$message('请上传图片');
                return;
            ...
            Object(__WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"])({
                ...
                _this3.loadingS.editTagGroup = true;
                if (res.success) {
                    _this3.tagGroup.status = 0;
                    _this3.tagGroup.edit = null;
                    _this3.getTagGroup();
                }
            }).catch(function (err) {
                _this3.loadingS.editTagGroup = true;
        ...
        //获取标签
        //获取标签列表
        getTagList: function getTagList(current, refresh) {
            var _this4 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/sign/find', { params: obj }).then(function (res) {
                console.log(res.data, 123123);
                _this4.loadingS.centerBox = true;
                _this4.requesttagList = res.data;
            }).catch(function (err) {
                _this4.loadingS.centerBox = true;
            });
        },
        //编辑标签 || 标签组
        editTag: function editTag(type, item) {
        ...
        saveTag: function saveTag() {
            ...
            var self = this;
            var query = JSON.parse(JSON.stringify(this.tagList.edit));
            delete query.id;
            if (!this.loadingS.editTag) {
                return;
            }
            this.loadingS.editTag = false;
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/sign/update/' + this.tagList.edit.id, query).then(function (res) {
                _this5.loadingS.editTag = true;
                if (res.success) {
                    //编辑标签对象制成空
                    _this5.tagList.edit = null;
                    //变成查看状态
                    _this5.tagList.status = 0;
                    //重新获取标签
        ...
        //保存标签  新增
        addSaveTag: function addSaveTag() {
            var _this6 = this;

            if (!this.loadingS.saveTag) {
                return;
            }
            this.addTag.type = this.tagGroup.current.type;
            this.$data.$validator.validateAll().then(function (pass) {
                if (pass) {
                    _this6.loadingS.saveTag = false;
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post('/api/wechat/admin/sign/add', _this6.addTag).then(function (res) {
                        _this6.loadingS.saveTag = true;
                        if (res) {
                            //新增标签对象制成空
                            _this6.addTagObj();
                            //变成查看状态
                            _this6.tagList.status = 0;
                            //重新获取标签
                            self.getTagList(self.tagGroup.current);
                        } else {
                            self.$message(res.message);
        ...
        //删除标签 标签组
        delTag: function delTag(type, item) {
            var self = this;
            var url = type === 'tag' ? '/api/wechat/admin/sign/drop/' + item.id : '/api/wechat/admin/sign/type/delete?id=' + item.id;
            var title = type === 'tag' ? item.value + '\u6807\u7B7E' : item.value + '\u6807\u7B7E\u7EC4';
            this.$confirm('\u6B64\u64CD\u4F5C\u5C06\u6C38\u4E45\u5220\u9664' + title + ', \u662F\u5426\u7EE7\u7EED?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(url).then(function (res) {
                    if (res.success) {
                        if (type === 'tag') {
                            self.getTagList(self.tagGroup.current);
                        } else {
        ...
        zdyhandleAvatarSuccess: function zdyhandleAvatarSuccess(res, type) {
            var that = this;
            if (res.success) {
        ...
        beforeAvatarUpload: function beforeAvatarUpload(file) {
            ...
            var isLt200kb = file.size / 1024 < 1000;
            if (!isJPG) {
        ...
        //点击标签
        getArticle: function getArticle(current) {
        ...
        fetchData: function fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/binding/find/entities', { params: query }).then(function (res) {
                if (res && res.success) {
                    _this7.loadingS.rightBox = true;
                    _this7.requestarticle = res.data.results || [];
                    _this7.article.totalSize = res.data.total;
                } else {
                    _this7.loadingS.rightBox = true;
                    _this7.requestarticle = [];
                }
            });
        },
        ...
        unbindTag: function unbindTag(e) {
            ...
            this.$confirm('\u6B64\u64CD\u4F5C\u5C06\u89E3\u7ED1\u6807\u7B7E, \u662F\u5426\u7EE7\u7EED?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat-admin-service/wechat/admin/binding?id=' + e.bindingId).then(function (res) {
                    if (res.success) {
                        _this8.fetchData();
                        self.$message({
                            type: 'success',
        ...
        imageClick: function imageClick(type) {
            // todo 修改icon或cover时要在以前的基础上+1 ？？？？
            var icon = type === 'iconImage' ? 'icon' : 'cover';
        ...
        //++++++++++  todo 弹出层 ++++++++++
        //预览获取文章详情
        lookDesign: function lookDesign(data) {
            var _this9 = this;

            var self = this;
            var e = data.realmId;
            self.loadingS.lookDesign = true;
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat-admin-service/wechat/admin/design/detail?id=' + e).then(function (res) {
                ...
                if (res.success) {
                    ...
                    if (!self.information.wechatImage) {
                        ...
                        _this9.$set(self.information.wechatImage, 'ext', null);
                        _this9.$set(self.information.wechatImage, 'imageMd5', null);
                        _this9.$set(self.information.wechatImage, 'imageUrl', null);
                        _this9.$set(self.information.wechatImage, 'name', null);
                        _this9.$set(self.information.wechatImage, 'reduceUrl', null);
                    }
                    if (!self.information.posterImage) {
                        self.information.posterImage = {};
                        _this9.$set(self.information.posterImage, 'ext', null);
                        _this9.$set(self.information.posterImage, 'imageMd5', null);
                        _this9.$set(self.information.posterImage, 'imageUrl', null);
                        _this9.$set(self.information.posterImage, 'name', null);
                        _this9.$set(self.information.posterImage, 'reduceUrl', null);
                    }

                    if (!self.information.bindingSignResultEntities) {
                        _this9.$set(_this9.information, 'signs', []);
                    } else {
                        _this9.$set(_this9.information, 'signs', self.information.bindingSignResultEntities);
                    }
        ...
        //开关标签组
        switchTagGroup: function switchTagGroup(e) {
            var _this10 = this;

            console.log(e);
            var ms = e.showValid ? '\u6B64\u64CD\u4F5C\u5C06\u6253\u5F00' + e.value + '\u6807\u7B7E\u7EC4,\u662F\u5426\u7EE7\u7EED\uFF1F' : '\u6B64\u64CD\u4F5C\u5C06\u9690\u85CF' + e.value + '\u6807\u7B7E\u7EC4\uFF0C\u662F\u5426\u7EE7\u7EED\uFF1F';
            this.$confirm(ms, '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(function () {
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/sign/type/' + e.id + '/on/off?showValid=' + e.showValid).then(function (res) {
                    if (res.code !== '000') {
                        _this10.$message('你的网络不稳定，请稍后重试');
        ...
        dragstart: function dragstart(item, type) {
            this.$set(this.drag, 'type', type);
            this.$set(this.drag, 'sd', item);
        },
        dragenter: function dragenter(item, type) {
        ...
        dragend: function dragend() {
            ...
            if (url) {
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(url).then(function (res) {
                    self.loadingS.saveTagGroup = true;
                    self.loadingS.centerBox = true;
                    if (res.code === '000' && _this11.drag.type === 'group') {
                        self.getTagGroup();
                    } else if (res.code === '000' && _this11.drag.type === 'tag') {
                        self.getTagList(self.tagGroup.current);
                    }
                    self.drag = {};
                }).catch(function (err) {
