...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        fetchData: function fetchData(e) {
            ...
            var url = '/api/wechat-service/wechat/more/queryUsers';
            var params = {
        ...
        saveRemark: function saveRemark() {
            ...
            var url = '/api/wechat-service/wechat/more/updateUserRemarks?id=' + currenItem.item.id + '&remarks=' + currenItem.remarks;
            if (that.views.loading) {
                return;
            }
            that.views.loading = true;
        ...
        synchronization: function synchronization() {
            ...
            if (!that.views.synchronization) {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat-service/wechat/more/getUsers?gzhId=' + that.query.gzh.appid).then(function (res) {
