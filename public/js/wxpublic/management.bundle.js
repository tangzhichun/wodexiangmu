...
var self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            var self = this;
            var url = '/api/wechat-service/wechat/more/queryAccessTokens';
        ...
        save: function save() {
            ...
            this.$data.$validator.validateAll().then(function (pass) {
                if (pass) {
                    ...
                    var method = 'post';
                    var url = '/api/wechat-service/wechat/more/insertAccessToken';
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"])({
                        ...
                        if (res.code === '000') {
                            if (method === 'post') {
                                //异步调菜单拉取线上数据 获取用户
                                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat-service/wechat/more/recoveryCurrentSelfmenuInfo?gzhId=' + self.information.appid);
                                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat-service/wechat/more/getUsers?gzhId=' + self.information.appid);
                                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat-service/wechat/more/pullReplyContentArticles?gzhId=' + self.information.appid);
                            }
                            self.cancelSave();
                            self.fetchData();
                        }
        ...
        delGZH: function delGZH(e) {
            this.$confirm('此操作将永久删除该公众号, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(function () {
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat-service/wechat/more/deleteAccessToken?appid=' + e).then(function (res) {
                    if (res.code === '000') {
                        self.fetchData();
                    }
                });
        ...
        openAllocation: function openAllocation(e) {
