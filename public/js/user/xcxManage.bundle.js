...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ui_dsp_cropper_vue__ = __webpack_require__(50);
/* jshint esversion: 6 */
...
let self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(url).then(response => {
        ...
        delXCX(e) {
            this.$confirm('此操作将永久删除该小程序吗, 是否继续?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/wechat/admin/mp/delete?id=${e}`).then(res => {
                    if (res.code === '000') {
                        self.fetchData();
                    }
                });
        ...
        getPage(e) {
            if (!this.views.getPage) {
                ...
                //获取小程序页面
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/link/list?appId=${this.xcxPage.xcx.appId}`).then(res => {
        ...
        delPages(e) {
            ...
            this.$confirm('此操作将永久删除此页面, 是否继续?', '提示', {
                ...
                if (!self.views.delPage) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/wechat/admin/link/delete?id=${e}`).then(res => {
                        self.views.delPage = false;
                        if (res.code === '000') {
                            self.views.getPage = true;
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/link/list?appId=${self.xcxPage.xcx.appId}`).then(res => {
                ...
                if (pass) {
                    setTimeout(() => {
                        ...
                        if (!obj.id) {
                            ...
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post('/api/wechat/admin/link/add', formData).then(res => {
                                if (res.code === '000') {
                            ...
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/link/add', formData).then(res => {
                                if (res.code === '000') {
                                    self.views.addPage = 0;
                                    self.formPage = {};
                                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/link/list?appId=${this.xcxPage.xcx.appId}`).then(res => {
