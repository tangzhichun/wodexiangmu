...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_select_dsp_pts_vue__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_cropper_vue__ = __webpack_require__(52);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    components: {
        ...
        // 合作方组件
        'dsp-pts': __WEBPACK_IMPORTED_MODULE_4__components_select_dsp_pts_vue__["a" /* default */],
        'dsp-cropper': __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_cropper_vue__["a" /* default */]
    },
    data: {
        meta: {
    ...
    methods: {
        fetchData: function fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/special/topic/list?page=' + self.query.currentPage + '&size=' + self.query.pageSize, { params: obj }).then(function (res) {
        ...
        handleClick: function handleClick(e) {
            ...
            if (e.type === 'edit') {
                ...
                this.$confirm('\u6B64\u64CD\u4F5C\u5C06\u6C38\u4E45\u5220\u9664<span style=\'color: red\'>' + e.a.name + '</span>\u4E13\u9898, \u662F\u5426\u7EE7\u7EED?', '提示', {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat/admin/special/topic?id=' + e.a.id).then(function (res) {
                        if (res.code === '000') {
                            self.$message({
                                type: 'success',
                                message: '删除成功!'
                ...
                //发布
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/special/topic/publish?id=' + e.a.id).then(function (res) {
                    if (res.code === '000') {
                        self.$message({
                            type: 'success',
                            message: '发布成功!'
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/special/topic/cancel?id=' + e.a.id).then(function (res) {
                    if (res.code === '000') {
                        self.$message({
                            type: 'success',
                            message: '已下线!'
        ...
        //打开新增 || 修改 专题
        editSpecial: function editSpecial(ele) {
            //有ele代表修改  没有代表新增
            if (ele) {
                var self = this;
                console.log(ele);
            ...
            this.$data.$validator.validateAll().then(function (pass) {
                if (pass) {
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"])({
                        ...
                        _this.views.saveSpecial = false;
                        _this.views.addSpecial = false;
                        if (res.success) {
                            _this.fetchData();
                        }
                    }).catch(function (err) {
        ...
        //转跳详情
        specialDetails: function specialDetails(ee) {
