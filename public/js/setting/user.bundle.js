...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_select_dsp_org_vue__ = __webpack_require__(174);
...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        clickPosition(data) {
            let self = this;
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/dealer/position/list/employee/${data.id}`).then(response => {
                if (response.data) {
        ...
        lookPrivilege(data) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/privilege/auth/list/user/${data.id}`).then(response => {
                if (response.data) {
                    let roleList = [];
