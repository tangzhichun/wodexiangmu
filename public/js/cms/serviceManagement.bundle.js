...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ui_dsp_empty_vue__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ui_dsp_cropper_vue__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_phone_vue__ = __webpack_require__(75);
/* jshint esversion: 6 */
...
let self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        getTagGroup: function () {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/sign/type/index`).then(res => {
        ...
        //获取标签
        //获取标签列表
        getTagList: function (current, refresh) {
            //refresh是否为刷新
            this.tagGroup.status = 0;
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/sign/find`, { params: obj }).then(res => {
        ...
        saveTag() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(`/api/wechat/admin/sign/update/${this.tagList.edit.id}`, query).then(res => {
        ...
        addSaveTag() {
            ...
            this.$data.$validator.validateAll().then(pass => {
                if (pass) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post(`/api/wechat/admin/sign/add`, this.addTag).then(res => {
        ...
        delTag(type, item) {
            ...
            this.$confirm(`此操作将永久删除${title}, 是否继续?`, '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(url).then(res => {
                    if (res.success) {
                        if (type === 'tag') {
                            self.getTagList(self.tagGroup.current);
                        } else {
        ...
        fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/binding/find/entities`, { params: query }).then(res => {
                if (res && res.success) {
        ...
        unbindTag(e) {
            this.$confirm(`此操作将解绑标签, 是否继续?`, '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/wechat-admin-service/wechat/admin/binding?id=${e.bindingId}`).then(res => {
                    if (res.success) {
                        this.fetchData();
                        self.$message({
                            type: 'success',
        ...
        lookDesign(data) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat-admin-service/wechat/admin/design/detail?id=${e}`).then(res => {
        ...
        switchTagGroup(e) {
            ...
            this.$confirm(ms, '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(`/api/wechat/admin/sign/type/${e.id}/on/off?showValid=${e.showValid}`).then(res => {
                    if (res.code !== '000') {
