...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_select_dsp_pts_vue__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ui_dsp_cropper_vue__ = __webpack_require__(50);
/* jshint esversion: 6 */
...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        fetchData() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/special/topic/list?page=${self.query.currentPage}&size=${self.query.pageSize}`, { params: obj }).then(res => {
        ...
        handleClick(e) {
            ...
            if (e.type === 'edit') {
                ...
                this.$confirm(`此操作将永久删除<span style='color: red'>${e.a.name}</span>专题, 是否继续?`, '提示', {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/wechat/admin/special/topic?id=${e.a.id}`).then(res => {
                        if (res.code === '000') {
                            self.$message({
                                type: 'success',
                                message: '删除成功!'
                ...
                //发布
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(`/api/wechat/admin/special/topic/publish?id=${e.a.id}`).then(res => {
                    if (res.code === '000') {
                        self.$message({
                            type: 'success',
                            message: '发布成功!'
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(`/api/wechat/admin/special/topic/cancel?id=${e.a.id}`).then(res => {
                    if (res.code === '000') {
                        self.$message({
                            type: 'success',
                            message: '已下线!'
