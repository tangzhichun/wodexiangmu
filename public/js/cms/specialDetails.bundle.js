...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ui_dsp_empty_vue__ = __webpack_require__(88);
...
var wxList = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            ...
            var self = this;
            var url = '/api/wechat/admin/special/topic/articleList?page=' + self.query.currentPage + '&size=' + self.query.pageSize;
            var params = {
                specialId: DSP.specialDetailsId,
                title: self.query.title
            };
            window.location.hash = self.$base64Encode(self.query);
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(url, { params: params }).then(function (res) {
                if (res.code === '000') {
                    _this.tableData = res.data.results;
                    _this.query.totalSize = res.data.totalSize;
                }
            }).catch(function (error) {});
        },
        getSpecialDetails: function getSpecialDetails() {
            var _this2 = this;

            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/special/topic/detail?id=' + DSP.specialDetailsId).then(function (res) {
                if (res.code === '000' && res.data) {
                    ...
                    _this2.specialDetails = res.data;
                }
            });
        },
        editPublishStatus: function editPublishStatus(e) {
            var _this3 = this;

            var url = '/api/wechat/admin/special/topic/cancel?id=' + DSP.specialDetailsId;
            if (e) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(url).then(function (res) {
                _this3.views.disabledPublishStatus = false;
                _this3.getSpecialDetails();
                if (res.code === '802') {
                    _this3.$message.error('专题最少包含3篇文章才可发布');
                }
            }).catch(function (err) {
                _this3.getSpecialDetails();
                _this3.views.disabledPublishStatus = false;
        ...
        del: function del(e) {
            ...
            this.$confirm('\u4F60\u786E\u5B9A\u5C06\u6B64\u6587\u7AE0\u79FB\u51FA' + self.specialDetails.name + '\u4E13\u9898\u5417?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat/admin/special/topic/deleteArticle', { data: obj }).then(function (res) {
                    if (res.code === '000') {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/design/detail?id=' + e).then(function (res) {
                ...
                if (res.success) {
                    ...
                    if (!self.information.wechatImage) {
                        ...
                        _this4.$set(self.information.wechatImage, 'ext', null);
                        _this4.$set(self.information.wechatImage, 'imageMd5', null);
                        _this4.$set(self.information.wechatImage, 'imageUrl', null);
                        _this4.$set(self.information.wechatImage, 'name', null);
                        _this4.$set(self.information.wechatImage, 'reduceUrl', null);
                    }
                    if (!self.information.posterImage) {
                        self.information.posterImage = {};
                        _this4.$set(self.information.posterImage, 'ext', null);
                        _this4.$set(self.information.posterImage, 'imageMd5', null);
                        _this4.$set(self.information.posterImage, 'imageUrl', null);
                        _this4.$set(self.information.posterImage, 'name', null);
                        _this4.$set(self.information.posterImage, 'reduceUrl', null);
                    }
                    ...
                    if (!self.information.bindingSignResultEntities) {
                        _this4.$set(_this4.information, 'signs', []);
                    } else {
                        _this4.$set(_this4.information, 'signs', self.information.bindingSignResultEntities);
                    }
