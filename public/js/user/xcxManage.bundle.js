...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ui_dsp_cropper_vue__ = __webpack_require__(52);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    components: {
        'dsp-cropper': __WEBPACK_IMPORTED_MODULE_2__components_ui_dsp_cropper_vue__["a" /* default */]
    },
    el: '#app',
    delimiters: ['{[', ']}'],
    data: {
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            var self = this;
            var url = '/api/wechat/admin/mp/list';
        ...
        openAddDialog: function openAddDialog(obj) {
            if (obj) {
        ...
        save: function save() {
            ...
            this.$data.$validator.validateAll().then(function (pass) {
                if (pass) {
                    ...
                    var method = 'post';
                    var url = '/api/wechat/admin/mp/add';
        ...
        delXCX: function delXCX(e) {
            this.$confirm('此操作将永久删除该小程序吗, 是否继续?', '提示', {
                confirmButtonText: '确定',
                cancelButtonText: '取消',
                type: 'warning'
            }).then(function () {
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat/admin/mp/delete?id=' + e).then(function (res) {
                    if (res.code === '000') {
                        self.fetchData();
                    }
                });
        ...
        getPage: function getPage(e) {
            ...
            if (!this.views.getPage) {
                ...
                //获取小程序页面
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/link/list?appId=' + this.xcxPage.xcx.appId).then(function (res) {
                    _this2.views.getPage = false;
                    if (res.data) {
                        _this2.$set(_this2.xcxPage, 'pages', res.data);
                        _this2.views.pageD = true;
                    }
                }).catch(function (err) {
                    _this2.views.getPage = false;
                });
        ...
        addPage: function addPage() {
            var obj = JSON.parse(JSON.stringify(this.xcxPage.pageObj));
            this.formPage = obj;
            this.views.addPage = 2;
        },

        //修改页面
        editPages: function editPages(e) {
            this.formPage = JSON.parse(JSON.stringify(e));
            this.views.addPage = 1;
        },

        //删除页面
        delPages: function delPages(e) {
            var self = this;
            this.$confirm('此操作将永久删除此页面, 是否继续?', '提示', {
                ...
                if (!self.views.delPage) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat/admin/link/delete?id=' + e).then(function (res) {
                        self.views.delPage = false;
                        if (res.code === '000') {
                            self.views.getPage = true;
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/link/list?appId=' + self.xcxPage.xcx.appId).then(function (res) {
        ...
        saveXCXPage: function saveXCXPage() {
            var _this3 = this;

            this.$data.$validator.validateAll().then(function (pass) {
                if (pass) {
                    setTimeout(function () {
                        var obj = JSON.parse(JSON.stringify(self.formPage));
                        if (!obj.id) {
                            var formData = {
                                appId: _this3.xcxPage.xcx.appId,
                                linkName: obj.linkName,
                                linkPath: obj.linkPath
                            };
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post('/api/wechat/admin/link/add', formData).then(function (res) {
                                if (res.code === '000') {
                                    self.views.addPage = 0;
                                    self.formPage = {};
                                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/link/list?appId=' + _this3.xcxPage.xcx.appId).then(function (res) {
                                        if (res.data) {
                                            _this3.$set(_this3.xcxPage, 'pages', res.data);
                                        }
                                    });
                                }
                            });
                            ...
                            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/link/add', _formData).then(function (res) {
                                if (res.code === '000') {
                                    self.views.addPage = 0;
                                    self.formPage = {};
                                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/link/list?appId=' + _this3.xcxPage.xcx.appId).then(function (res) {
