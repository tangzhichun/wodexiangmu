...
let self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        fetchData(e) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(url, { params: obj }).then(res => {
        ...
        delAgent(e) {
            ...
            this.$confirm(title, '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/mpuser/service/agent/delete`, { params: obj }).then(res => {
                    if (res.code !== '000') {
