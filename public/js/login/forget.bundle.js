...
var forget = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    el: '#app',
    delimiters: ['{[', ']}'],
    data: function data() {
        var _this = this;
        ...
        var mobileValidator = function mobileValidator(rule, value, callback) {
            var m = /^0?(11|12|13|14|15|16|17|18|19)[0-9]{9}$/;
            if (m.test(_this.ruleForm.mobile)) {
                callback();
            } else {
        ...
        var oldpassword = function oldpassword(rule, value, callback) {
            if (_this.ruleForm.password.length > 4 && _this.ruleForm.password.length < 23 || value.length === 0) {
                callback();
            } else {
        ...
        var newpassword = function newpassword(rule, value, callback) {
        ...
        return {
            ...
            rules: {
                ...
                password: [{ validator: oldpassword, trigger: 'blur' }],
    ...
    methods: {
        getCode: function getCode() {
            ...
            if (m.test(this.ruleForm.mobile)) {
                if (!this.yesNo.timer) {
                    ...
                    this.yesNo.timer = setInterval(function () {

                        if (_this2.yesNo.count > 0 && _this2.yesNo.count <= TIME_COUNT) {
                            _this2.yesNo.count--;
                        } else {
                            _this2.yesNo.show = true;
                            clearInterval(_this2.yesNo.timer);
                            _this2.yesNo.timer = null;
                        }
                    }, 1000);
                }
                if (this.ruleForm.validation1 === '发送验证码') {
                    var mobile = this.ruleForm.mobile;
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded';
        ...
        submitForm: function submitForm() {
            var m = /^0?(13|14|15|17|18|19)[0-9]{9}$/;
            if (!m.test(this.ruleForm.mobile)) {
