...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    data: {
        ...
        meta: {
            //意向品类
            INTENTION: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('INTENTION'),
            //意向品类
            BRAND: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].BRAND,
            // 年龄段
            AGES: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].CUST_AGE_RANGE,
            //家庭构成
            FAMILY_COMPOSITION: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('FAMILY_COMPOSITION'),
            // 区域
            REGION: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('REGION'),
            //客户来源
            KHLY: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('KHLY'),
            // 职业
            PROFESSION: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('PROFESSION'),
            // 房屋面积
            HOUSING_AREA: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('HOUSING_AREA'),
            // 房屋户型
            FWHX: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('FWHX'),
            // 装修阶段
            DECORATION_STAGE: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('DECORATION_STAGE'),
            // 装修风格
            DECORATION_STYLE: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('DECORATION_STYLE'),
            // 装修预算
            DECORATION_BUDGET: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('DECORATION_BUDGET'),
            // 装修进度
            START_DATE: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].dict('START_DATE'),
            // 房屋类型
            CUST_HOUSE_TYPE: __WEBPACK_IMPORTED_MODULE_2__scripts_module_enums__["default"].CUST_HOUSE_TYPE
                ...
                information: {
                    ...
                    mobile: {
                        ...
                        remote: function remote($data, value) {
                            ...
                            return __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/customer/duplicate/check/' + value).then(function (response) {
                                //返回false，表示验证未通过；返回true，表示验证通过。
    ...
    methods: {
        ...
        // 删除销售机会
        deleteOpportunity: function deleteOpportunity(index) {
            this.information.houses.splice(index, 1);
        },

        // 地址下拉框改变后，将市区拆为2个字段存储
        addressChange: function addressChange(value) {
            this.information.familyCity = value[0];
            this.information.familyArea = value[1];
        },
        officeAddressChange: function officeAddressChange(value) {
