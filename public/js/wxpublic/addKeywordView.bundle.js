...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        //删除关键字
        delKeyWord: function delKeyWord(i) {
        ...
        save: function save() {
            ...
            var self = this;
            var obj = {
                keywordsList: self.keyWord.filter(function (el) {
                    return el.keyword;
                }),
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post('/api/wechat-service/wechat/more/saveNewsKeywords', obj).then(function (res) {
        ...
        delKeywor: function delKeywor() {
            ...
            this.$confirm('确定要删除吗?', '删除', {
                ...
                _this.views.save = true;
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat-service/wechat/more/deleteNewsKeywords?replyId=' + DSP.keywordData.id).then(function (res) {
                    if (res.code === '000') {
                        _this.$message({
                            type: 'success',
                            message: '删除成功!'
