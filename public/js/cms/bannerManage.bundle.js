...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_ui_xcx_page_skip_vue__ = __webpack_require__(163);
/* jshint esversion: 6 */
...
var self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        saveAndSubmit() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post(url, item).then(response => {
        ...
        editAndSubmit() {
            ...
            console.log(item);
            // if (1===1){return;}
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(url, item).then(response => {
