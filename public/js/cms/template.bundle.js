...
let self = new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        getTemplate() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/share/template/${self.query.currentPage}/${self.query.pageSize}`, { params: params }).then(res => {
        ...
        deleteInformation(e) {
            this.$confirm('此操作将永久删除该模版, 是否继续?', '提示', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete(`/api/wechat/admin/share/template/${e.id}`).then(res => {
                    if (res.code === '000') {
                        self.getTemplate();
                        self.$message({
                            type: 'success',
        ...
        queryDesignList() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/wechat/admin/design/${self.designQuery.template.id}/template`).then(res => {
        ...
        queryDesignTitle() {
            let self = this;
            this.designQuery.current = 1;
            let arr = self.designList.filter(el => {
