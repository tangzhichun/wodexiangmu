                ...
                information: {
                    ...
                    mobile: {
                        ...
                        remote: function ($data, value) {
                            ...
                            return __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get(`/api/customer/duplicate/check/${value}`).then(response => {
                                //返回false，表示验证未通过；返回true，表示验证通过。
        ...
        saveIt($event) {
            this.$data.$validator.validateAll().then(pass => {
                if (pass) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post(url, data).then(response => {
