...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    delimiters: ['{[', ']}'],
    data: {
        categoryList: [{ value: 'USER', label: '员工' }, { value: 'OPERATION', label: '合作方' }],
        category: 'USER',
        loading: false,
        // 界面输入的查询条件
        query: {
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            ...
            var url = '/api/wechat/admin/user?page=' + that.query[that.category].currentPage + '&size=' + that.query[that.category].pageSize;
            that.loading = true;
        ...
        indexMethod: function indexMethod(index) {
            var that = this;
            var i = that.query[that.category].pageSize * (that.query[that.category].currentPage - 1) + 1;
            return i + index;
        }
    },
