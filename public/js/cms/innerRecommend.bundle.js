...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        getLeftList() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/content/recommended/leftList').then(res => {
        ...
        getRightList(tou) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].get('/api/wechat/admin/content/recommended/rightList', { params: obj }).then(res => {
        ...
        putLeftShift(e, type) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put(`/api/wechat/admin/content/recommended/${type}`, obj).then(res => {
                if (res.code === '000') {
        ...
        putUpAndDownShift(e, i) {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].put('/api/wechat/admin/content/recommended/dragAndDropShift', obj).then(res => {
                this.views.guardRepetitive = false;
                if (res.code === '000') {
                    this.getLeftList();
