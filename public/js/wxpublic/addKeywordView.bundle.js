...
new __WEBPACK_IMPORTED_MODULE_0__scripts_module_vue__["default"]({
    ...
    methods: {
        ...
        save() {
            ...
            __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].post('/api/wechat-service/wechat/more/saveNewsKeywords', obj).then(res => {
        ...
        delKeywor() {
            ...
            this.$confirm('确定要删除吗?', '删除', {
                ...
                __WEBPACK_IMPORTED_MODULE_1__scripts_module_axios__["default"].delete('/api/wechat-service/wechat/more/deleteNewsKeywords?replyId=' + DSP.keywordData.id).then(res => {
                    if (res.code === '000') {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
